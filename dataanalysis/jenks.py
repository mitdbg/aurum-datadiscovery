            ...
            if i4 != 0:
                for j in range(2, n_classes + 1):
                    if variance_combinations[l][j] >= (variance + variance_combinations[i4][j - 1]):
                        ...
                        variance_combinations[l][
                            j] = variance + variance_combinations[i4][j - 1]
...
def main():
    pp(jenks([1, 2, 2, 3, 12, 2, 2, 1, 2, 11, 1, 11, 1, 1, 1, 1, 1, 1, 1, 1, 2,
              1, 9, 8, 9, 8, 9, 8, 9, 8, 9, 8, 9, 8, 9, 8, 1, 2, 1, 2, 1, 2, 1, 2], 4))
