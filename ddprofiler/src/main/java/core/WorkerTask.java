...
public class WorkerTask implements Closeable {
    ...
    public static WorkerTask makeWorkerTaskForCSVFile(String dbName, String path, String name, String separator) {
    ...
    public static WorkerTask makeWorkerTaskForDB(String dbName, DBType dbType, String connIP, String port,
	    String sourceName, String tableName, String username, String password) {
	// Retrieve existing pool connection or create a new one if necessary
	Connection c = DBConnector.getOrCreateConnector(dbName, dbType, connIP, port, sourceName, tableName, username,
		password);

	DBConnector dbc = new DBConnector(c, dbName, dbType, connIP, port, sourceName, tableName, username, password);
