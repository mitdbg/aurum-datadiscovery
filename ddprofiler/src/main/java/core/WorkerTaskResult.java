...
public class WorkerTaskResult {
  ...
  public WorkerTaskResult(int id, String sourceName, String columnName,
                          String dataType, int totalValues, int uniqueValues,
                          String entities) {
    this.id = id;
  ...
  public WorkerTaskResult(int id, String sourceName, String columnName,
                          String dataType, int totalValues, int uniqueValues,
                          float minValue, float maxValue, float avgValue,
  ...
  public float getAvgValue() { return avgValue; }
