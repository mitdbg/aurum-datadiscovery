...
public class PreAnalyzerTest {
  ...
  public void workloadTest(List<String> test_strings, PreAnalyzer pa) {
    ...
    System.out.println("Exception method took: " + (endTime - startTime) +
                       " milliseconds");
    System.out.println(
        "----------------------------------------------------------------\n\n");
    ...
    System.out.println("Reg Exp based method took: " + (endTime - startTime) +
                       " milliseconds");
  }
  ...
  public void testRegExpPerformance() {
    ...
    // testing workloads that are numberical values, in this case the try-catch
