...
public class TestOfflineMode {
	...
	public void proceedCommand(String[] command){
		...
		Properties validatedProperties = Main.validateProperties(commandLineProperties);
	...
	public void offlineModeTest() {
		String[] args_test1 = new String[]{"-execution.mode", "1", "-num.record.read", "100",
				"-sources.folder.path", "C:\\csv\\", "-help"};
