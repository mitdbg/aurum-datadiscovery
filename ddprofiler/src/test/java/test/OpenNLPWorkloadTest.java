...
public class OpenNLPWorkloadTest {
	...
	private String[] personArr2 = {"Sibo Wang", "Ziawasch Abedjan", "Raul Castro Fernandez","Nan Tang", "Mourad Ouzzani", 
			"Miachel Stonebraker", "Sam Madden", "Ahmed Elmagarmid "};
	
	//cannot identify any of the address below
	private String[] locationArr = {"BLK 265, Singapore", "77 Massachusetts Ave, Cambridge, MA 02139",
