...
public class NumericalEstimatorAccuracyTest {
	...
	public void loadGenerator(List<Float> randomList) {
		System.out.println("True 25 percentile: "+ randomList.get(RANDOM_SEQ_LENGTH*25/100));
		System.out.println("True 50 percentile: "+ randomList.get(RANDOM_SEQ_LENGTH*50/100));
		System.out.println("True 75 percentile: "+ randomList.get(RANDOM_SEQ_LENGTH*75/100));
	...
	public void testGaussianInput() {
		...
		loadGenerator(randomList);
		System.out.println("------------------end of Gaussian workload test---------------------");
	}
	...
	public void testUniformInput(){
		...
		System.out.println("Cardinality:" + uniqueElements);
		loadGenerator(randomList);
		System.out.println("------------------end of Uniform workload test---------------------");
